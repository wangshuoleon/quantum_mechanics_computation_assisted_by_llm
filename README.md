...
\left[
\frac{1}{R}
+\frac{1}{|\mathbf R+\mathbf r_2-\mathbf r_1|}
-\frac{1}{|\mathbf R-\mathbf r_1|}
-\frac{1}{|\mathbf R+\mathbf r_2|}
\right]
$$
...
\left[
\frac{\mathbf d_A\cdot\mathbf d_B-3(\mathbf d_A\cdot\hat{\mathbf R})(\mathbf d_B\cdot\hat{\mathbf R})}{R^3}
\right]
$$
...
$$
V_{\rm dd}=
\frac{e^2}{4\pi\epsilon_0 R^3}
\left[
\mathbf r_1\cdot\mathbf r_2
-3(\mathbf r_1\cdot\hat{\mathbf R})(\mathbf r_2\cdot\hat{\mathbf R})
\right]
$$
...
$$
\langle 0|\mathbf d_A|0\rangle=0,\qquad
\langle 0|\mathbf d_B|0\rangle=0
$$

所以偶极-偶极相互作用的一阶微扰为

$$
E^{(1)}=\langle 0|V_{\rm dd}|0\rangle=0
$$
...
E^{(2)}=
\sum_{n\ne 0}
\frac{|\langle n|V_{\rm dd}|0\rangle|^2}{E_0-E_n}
$$

其中 $|n\rangle$ 是 $H_0$ 的激发态。
因为 $V_{\rm dd}\propto 1/R^3$，所以
...
E^{(2)}
=
-\frac{1}{(4\pi\epsilon_0)^2 R^6}
\sum_{i,j,k,l}
T_{ij}T_{kl}
\langle 0|d_{A,i}d_{A,k}|0\rangle
\langle 0|d_{B,j}d_{B,l}|0\rangle
$$
...
=
\frac{2}{3}\sum_{n\ne 0}
\frac{|\langle n|\mathbf d_A|0\rangle|^2(E_n-E_0)}
{(E_n-E_0)^2+\omega^2}
$$
...
\int_0^\infty \alpha_A(i\omega)\alpha_B(i\omega)\,d\omega
$$
...
-\frac{3\hbar}{\pi R^6}
\frac{1}{(4\pi\epsilon_0)^2}
\int_0^\infty [\alpha(i\omega)]^2\,d\omega
$$
...
$$
C_6=
\frac{3\hbar}{\pi(4\pi\epsilon_0)^2}
\int_0^\infty [\alpha_{\rm H}(i\omega)]^2\,d\omega
$$
...
$$
\alpha_{\rm H}\sim 4\pi\epsilon_0 a_0^3
$$
...
$$
E_{\rm vdW}\approx -6.5\frac{e^2}{4\pi\epsilon_0}\frac{a_0^5}{R^6}
$$
...
$$
\boxed{
C_6\sim 6.5\,\frac{e^2}{4\pi\epsilon_0}a_0^5
}
$$
